...
const Video = ({ video }) => {
  return (
    <div className='mt-32 p-0 m-0'>
      <Link to={`/video/${video?.videoId}`}>
        <div className='flex flex-col p-0 m-0'>
          <div className='h-48 md:h-56 md:rounded-xl hover:rounded-none duration-200 overflow-hidden relative p-0 m-0'>
            <img className='h-full w-full p-0 m-0' src={video?.thumbnails[0]?.url} alt="" />
