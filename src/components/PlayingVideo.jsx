    ...
    <div className='flex justify-center flex-row h-[calc(100%-56px)] mt-16  '>
      <div className='w-full max-w-[1400px] flex flex-col lg:flex-row '>
        <div className='flex flex-col lg:w-[calc(100%-350px)] xl:w-[100%-400px] px-4 py-3 lg:py-6'>
          <div className='h-[200px] md:h-[500px] ml-[-16px] ml[-16px] lg:ml-0 lg:mr-0'>
            <ReactPlayer
        ...
        <div className='flex flex-col px-4 py-6 h-[calc(100vh-4.62rem)] overflow-y-scroll overflow-x-hidden lg:w-[350] xl:[400px]' >
